...
import com.myorg.javacourse.amitcohenapp321.model.*;
import com.myorg.javacourse.amitcohenapp321.model.Stock.ALGO_RECOMMENDATION;
...
public class PortfolioManager implements PortfolioManagerInterface {
	...
	private Stock fromDto(StockDto stockDto) {
		...
		if(stockDto.getRecommendation() != null) newStock.setRecommendation(com.myorg.javacourse.amitcohenapp321.model.Stock.ALGO_RECOMMENDATION.valueOf(stockDto.getRecommendation()));
		else 
		{
